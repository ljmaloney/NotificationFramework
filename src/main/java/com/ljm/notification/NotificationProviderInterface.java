 ...
 * @since October 2013
 */
public interface NotificationProviderInterface
{
    ...
    * @param message 
    */
    public void sendMessage(NotificationDestination destinations,NotificationMessageInterface message) throws NotificationException;
    /**
    * 
    * @param destinations
    * @param message 
