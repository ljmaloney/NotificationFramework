    ...
    public void sendMessage(NotificationDestination destination,NotificationMessageInterface message) throws NotificationException
    {
        ...
        try 
        {
            ...
            else 
            {
                ...
                throw new NotificationException("Error sending HTTP notification, errorcode="+response.getResponseCode());
            }
        ...
        catch(IOException ioe)
        {
            ...
            throw new NotificationException("IOException sending notification using soundbite. QueryStr="+queryStr, ioe);
        }
        catch(Exception e) 
        {
