...
import com.ljm.notification.AbstractJsonNotificationProvider;
import com.ljm.notification.NotificationDestination;
import com.ljm.notification.NotificationMessageInterface;
import com.ljm.notification.NotificationMessageMap;
...
public class XanbooPushProvider extends AbstractJsonNotificationProvider
{
    ...
    */
    ...
    public String createJSON(NotificationDestination destination, NotificationMessageInterface message)
    {
        ...
        if ( message.getMessageProperties().get(NotificationMessageMap.BUTTON_NAME) != null )
            jsonBldr.append("\"actionKey\":\"").append(message.getMessageProperties().get(NotificationMessageMap.BUTTON_NAME)).append("\",");
        ...
        jsonBldr.append("\"dguid\":\"").append(message.getMessageProperties().get(NotificationMessageMap.DGUID)).append("\",");
        jsonBldr.append("\"catalogId\":\"").append(message.getMessageProperties().get(NotificationMessageMap.CATALOG_ID)).append("\",");
        ...
        switch(message.getMessageType())
        {
            ...
            case OID_MESSAGE :
                ...
                jsonBldr.append("\"value\":\"").append(message.getMessageProperties().get(NotificationMessageMap.OBJECT_VALUE)).append("\",");
                break;
            case DEVICE_ACTION : 
                jsonBldr.append("\"eid\":\"").append(((NotificationMessageMap.DeviceActionType)message.getMessageProperties().get(NotificationMessageMap.DEVICE_ACTION_TYPE)).getType()).append("\",");
                break;
            default :
        ...
        if ( message.getMessageProperties().containsKey(NotificationMessageMap.DOORBELL_CAMERA_URL) )
        ...
        {
            if ( message.getMessageProperties().containsKey(NotificationMessageMap.DOORBELL_CAMERA_URL) ) custBldr.append(", ");
