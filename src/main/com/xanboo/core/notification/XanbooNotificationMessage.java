 ...
 * @since October 2013
 */
public class XanbooNotificationMessage implements NotificationMessageInterface 
{
    /**account id**/
    ...
    /**Message properties **/
    private XanbooMessageMap messageProperties = new XanbooMessageMap();
    private XanbooCustomMap customMap = null;
    private XanbooResponseMap responseMap = null;
    ...
    * Constructor
    */
    public XanbooNotificationMessage()
    {
        Date currDate = new Date();
        DateFormat df = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
        messageProperties.put(XanbooMessageMap.TIMESTAMP, df.format(currDate));
    ...
    * @param messageMap 
    */
    public XanbooNotificationMessage(String subject,String message,String fromAddress,String[] toAddresses,XanbooMessageMap messageMap)
    {
        this();
    ...
    * @param messageMap 
    */
    public XanbooNotificationMessage(String subject,String message,String fromAddr,String toAddress,XanbooMessageMap messageMap)
    {
        this();
        this.subject = subject;
        this.message = message;
    ...
    */
    ...
    {
        this.accountId = id;
        getMessageProperties().put(XanbooMessageMap.ACCOUNTID, id);
    }
    /**
    ...
    */
    ...
    {
        this.alarmCode = code;
        getMessageProperties().put(XanbooMessageMap.ALARM_CODE, code);
        putCustomProperty(XanbooCustomMap.ALARM_CODE,code,XanbooCustomMap.DataType.STRING);
    }
    ...
    */
    ...
    public XanbooCustomMap getCustomMap()
    {
        if ( customMap == null ) customMap = new XanbooCustomMap();
        return customMap;
    }
    ...
    public Object putCustomProperty(String key, Object value, XanbooCustomMap.DataType type)
    {
        if ( customMap == null ) customMap = new XanbooCustomMap();
    ...
    */
    ...
    public void setExternalAccountId(String id)
    {
        ...
        getMessageProperties().put(XanbooMessageMap.EXTERNAL_ACCT_ID, id);
    }
    /** 
    ...
    */
    ...
    @Override
    public XanbooMessageMap getMessageProperties()
    {
    ...
    {
    	if(this.messageProperties.get(XanbooMessageMap.NOTIF_TYPE) instanceof String) {
    		String type =(String)this.messageProperties.get(XanbooMessageMap.NOTIF_TYPE);
    	...
    	} else if (this.messageProperties.get(XanbooMessageMap.NOTIF_TYPE) instanceof NotificationMessageInterface.MessageType){
    		return (NotificationMessageInterface.MessageType)this.messageProperties.get(XanbooMessageMap.NOTIF_TYPE);
    	}
        return null;    //should never return null
    }
    public void setMessageType(NotificationMessageInterface.MessageType messageType)
    {
        this.messageProperties.put(XanbooMessageMap.NOTIF_TYPE, messageType.type);
    }
    @Override
    public String getObjectValue()
    {
        return (String)this.messageProperties.get(XanbooMessageMap.OBJECT_VALUE);
    }
    ...
    */
    ...
    public XanbooResponseMap getResponseMap()
    {
        if ( responseMap == null ) responseMap = new XanbooResponseMap();
        return responseMap;
    }
    ...
    */
    ...
    public void setSubscriberId(String id)
    {
        ...
        getMessageProperties().put(XanbooMessageMap.SUBSCRIBER_ID, id);
    }
    @Override
    ...
    public void setSubscriberName(String name)
    {
        ...
        getMessageProperties().put(XanbooMessageMap.SUBSCRIBER_NAME, name);
    }
    /**
    ...
    */
    ...
    public String getTimestamp()
    {
        ...
        return (String)getMessageProperties().get(XanbooMessageMap.TIMESTAMP);
    }
    ...
    public void setTimestamp(String timestamp)
    {
        ...
        getMessageProperties().put(XanbooMessageMap.TIMESTAMP,timestamp);
    }
